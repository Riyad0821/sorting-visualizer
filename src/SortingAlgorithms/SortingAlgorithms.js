...
function doMerge(
    ...
    while (i <= middleIdx && j <= endIdx) {
        ...
        animations.push([i, j]);
        // These are the values that we're comparing; we push them a second time t revert their color.
        animations.push([i, j]);
    ...
    while (i <= middleIdx) {
        // These are the values that we're comparing; we push them a once to change their color.
        animations.push([i, i]);
